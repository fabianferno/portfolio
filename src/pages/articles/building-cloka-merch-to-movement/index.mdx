...
import cloka1 from '@/images/blog/cloka-1.png'
import cloka2 from '@/images/blog/cloka-2.png'
import cloka3 from '@/images/blog/cloka-3.png'
import cloka4 from '@/images/blog/cloka-4.png'

export const meta = {
  author: 'Fabian Ferno',
  date: '2025-12-13',
  image: cloka1,
  title: 'how we built cloka: merch to movement',
  description:
...
<Image src={cloka1} alt="Cloka storefront and branding" className="my-8 rounded-xl" />
...
<Image src={cloka2} alt="Cloka pivot to social health tech" className="my-8 rounded-xl" />
...
why mongo? because rigid schemas kill creativity. early cloka was chaos. features changed daily. sql migrations would have slowed me down. mongo let me dump objects and figure it out later. flexible schema for a flexible roadmap.
...
<Image src={cloka3} alt="Cloka Arcs feature" className="my-8 rounded-xl" />
...
<Image src={cloka4} alt="Cloka handling scale and images" className="my-8 rounded-xl" />

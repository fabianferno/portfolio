...
if you want to skip the research and go straight to my inferences, click [here](#general-inferred-rules-for-pf-from-my-research).
...
<a name="general-inferred-rules-for-pf-from-my-research"></a>
## general inferred rules for pf from my research
